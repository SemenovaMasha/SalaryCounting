...
{
    public partial class PaySheetsListForm : Form
    {
        PaySheetSet set = new PaySheetSet();
        List<PaySheetFilter> list;
        public PaySheetsListForm()
        {
            InitializeComponent();
            refreshDataGrid();
        }
        ...
        private void editToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                PaySheetForm form = new PaySheetForm(list[dataGridSheets.SelectedRows[0].Index]);
                form.ShowDialog();
                refreshDataGrid();
            }
        }
